...
namespace Battle.Skills {
    public class Eugene_2_l_SkillLogic : BaseSkillLogic {   //statusEffect에 스킬에 붙은 패시브 효과를 저장할 방법이 (현재로썬) 없기 때문에,
        ...
        public override IEnumerator TriggerStatusEffectAtActionEnd(Unit target, UnitStatusEffect statusEffect) {   //순수한 물 skillLogic
        ...
        public override void TriggerStatusEffectAtPhaseStart(Unit target, UnitStatusEffect statusEffect) { //청명수의 은총 skillLogic
